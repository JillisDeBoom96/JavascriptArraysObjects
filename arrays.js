...
// ==========================================
const year = [2000, 2005, 2010, 2015, 1908];
console.log(year);
// ==========================================
...
// ==========================================
const hobby = ["Slapen, Laat wakker blijven & netflix tot ik in slaap val"];
console.log(hobby);
...
// ==========================================
const voer = ["bladerdeeg", "knoflook", "spinazie"]
voer[0] = "lasagne bladen"
console.log(voer)
console.log(voer.length)
