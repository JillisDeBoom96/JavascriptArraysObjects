...
// 4d. Log de afmetingen (b-h-d) in de terminal
...
const waterKoker = "De " + product.productName + " is gemaakt van " + product.material[0] + " en " + product.material[1]
console.log(waterKoker)
